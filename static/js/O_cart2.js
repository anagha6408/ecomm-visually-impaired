...
function updateUserOrder(productId, action) {
    ...
    fetch(url, {
        ...
        .then((data) => {
            ...
            if (action === "delete") {
                showVoiceAlert("Item successfully removed from your cart!");
            } else if (action === "Increase") {
                showVoiceAlert("Item quantity increased!");
            } else if (action === "Decrease") {
                showVoiceAlert("Item quantity decreased!");
            } else if (action === "add") {
                showSuccessAlert();
            }
            location.reload();
...
function showSuccessAlert() {
    ...
    console.log("Item successfully added to your cart");
    showVoiceAlert(message);
}
